...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('[AUDIO_ANALYZE] Calling ML API:', apiUrl);
    ...
    try {
      ...
      if (!response.ok) {
        ...
        console.error('[AUDIO_ANALYZE] ML API failed with status:', response.status);
        console.error('[AUDIO_ANALYZE] ML API error response:', errorText);
    ...
    console.error('[AUDIO_ANALYZE] Error:', error);
